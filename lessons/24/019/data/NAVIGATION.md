...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CUSTOM,GYRATION,UPPER_WALLS,DISTANCE,COORDINATIONNUMBER,PRINT,COM,ONES,COMBINE,CONTACT_MATRIX,MATRIX_VECTOR_PRODUCT,MEAN,COORDINATION,LOWER_WALLS,METAD,FLUSH,UNITS,GROUP" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
