...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,COM,RESTART,PRINT,UNITS,COORDINATION,LOWER_WALLS,FLUSH,MOLINFO,UPPER_WALLS,TORSION,RESTRAINT,EXTENDED_LAGRANGIAN,WHOLEMOLECULES,DISTANCE,METAD" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
