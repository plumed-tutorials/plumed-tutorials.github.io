...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RESTRAINT,FLUSH,MOLINFO,COM,WHOLEMOLECULES,PRINT,RESTART,GROUP,COORDINATION,EXTENDED_LAGRANGIAN,UPPER_WALLS,TORSION,METAD,UNITS,LOWER_WALLS,DISTANCE" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
