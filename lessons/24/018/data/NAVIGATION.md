...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PIV,FUNCPATHMSD,UPPER_WALLS,PRINT,PLUMED,CELL,LOWER_WALLS,METAD" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
