...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,METAD,HBOND_MATRIX,READ,DUMPGRID,PRINT,REWEIGHT_METAD,FLUSH,COORDINATION,CUSTOM,ANGLE,UNITS,HISTOGRAM,DISTANCE,UPPER_WALLS" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
