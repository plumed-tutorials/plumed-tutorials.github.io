...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,READ,REWEIGHT_METAD,COORDINATION,PRINT,UNITS,HISTOGRAM,CUSTOM,FLUSH,DUMPGRID,UPPER_WALLS,ANGLE,HBOND_MATRIX,DISTANCE,METAD" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
