...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOVINGRESTRAINT,MOLINFO,WHOLEMOLECULES,UPPER_WALLS,LOWER_WALLS,DISTANCE,PATHMSD,PRINT,METAD,CENTER" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
