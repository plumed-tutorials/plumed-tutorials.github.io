...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,WHOLEMOLECULES,FIXEDATOM,PRINT,OPES_METAD_EXPLORE,OPES_EXPANDED,MATHEVAL,FIT_TO_TEMPLATE,COORDINATION,LOWER_WALLS,ANGLE,CENTER,ENERGY,ECV_MULTITHERMAL,DISTANCE,UPPER_WALLS" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
