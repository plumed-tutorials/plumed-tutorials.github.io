...
When redeveloping all the [modules](https://www.plumed.org/doc-master/user-doc/html/_w_h_a_m.html) I have developed over the last few years, I focus on clarity of documentation rather 
...
CVs such as [Q6](https://www.plumed.org/doc-master/user-doc/html/_q6.html) are calculated, and how the calculation of these quantities can be extended. Furthermore, when they need something more computationally efficient, clear 
