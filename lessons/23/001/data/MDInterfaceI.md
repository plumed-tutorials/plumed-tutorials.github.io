...
there must also be some PLMD::Action that converts the data in void pointer into a PLMD::Value. These two PLMD::Actions are called [GET](https://www.plumed.org/doc-master/user-doc/html/_g_e_t.html) and PUT. This article 
gives a brief introduction to these Actions. 

## [GET](https://www.plumed.org/doc-master/user-doc/html/_g_e_t.html) 

The PLMD::Action [GET](https://www.plumed.org/doc-master/user-doc/html/_g_e_t.html) inherits from PLMD::ActionWithArguments. This command takes in a single PLMD::Value and transfers the contents of the `data` vector for the 
...
p.cmd("readInputLine", "d1: [DISTANCE](https://www.plumed.org/doc-master/user-doc/html/_d_i_s_t_a_n_c_e.html) ATOMS=1,2") 
# Get the rank of the PLMD::Value that holds the distance 
# This command sets up the [GET](https://www.plumed.org/doc-master/user-doc/html/_g_e_t.html) object 
...
# [GET](https://www.plumed.org/doc-master/user-doc/html/_g_e_t.html) object 
...
Notice that you can have as many [GET](https://www.plumed.org/doc-master/user-doc/html/_g_e_t.html) actions as you need. The data is transferred from the PLMD::Value to the void pointer when the `calculate` method of GET is called. 
...
## [PUT](https://www.plumed.org/doc-master/user-doc/html/_p_u_t.html) 

The PLMD::Action [PUT](https://www.plumed.org/doc-master/user-doc/html/_p_u_t.html) inherits from PLMD::ActionWithValue. [PUT](https://www.plumed.org/doc-master/user-doc/html/_p_u_t.html) transfers the data from a void pointer passed to PLMD from the calling code to a PLMD::Value. The calling 
...
```c++ 
plumed.cmd("readInputLine n: [PUT](https://www.plumed.org/doc-master/user-doc/html/_p_u_t.html) SHAPE=3,3 UNIT=length PERIODIC=NO"); 
``` 
...
is created from a [PUT](https://www.plumed.org/doc-master/user-doc/html/_p_u_t.html) action `storedata` is set to true. PUT also has a CONSTANT flag that allows you to transfer variables such as the value of the timestep that is set only once during the 
...
are transferred when the share and wait methods of the [DOMAIN_DECOMPOSITION](https://www.plumed.org/doc-master/user-doc/html/_d_o_m_a_i_n__d_e_c_o_m_p_o_s_i_t_i_o_n.html) action are called. However, I will write more about that in another post. 
