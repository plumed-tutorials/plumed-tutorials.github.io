...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,EFFECTIVE_ENERGY_DRIFT,PRINT,WHOLEMOLECULES,METAD,COMBINE,CUSTOM,DEBUG,RMSD,GROUP,DISTANCE" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
