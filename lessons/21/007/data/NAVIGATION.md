...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,DISTANCE,EFFECTIVE_ENERGY_DRIFT,RMSD,COMBINE,PRINT,DEBUG,CUSTOM,GROUP,METAD,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
