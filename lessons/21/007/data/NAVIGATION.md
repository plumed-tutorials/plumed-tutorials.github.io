...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=EFFECTIVE_ENERGY_DRIFT,DEBUG,METAD,DISTANCE,CUSTOM,RMSD,COMBINE,WHOLEMOLECULES,GROUP,PRINT,COORDINATION" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
