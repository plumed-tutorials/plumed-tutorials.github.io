...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=METAD,DISTANCE,GROUP,WHOLEMOLECULES,COMBINE,RMSD,EFFECTIVE_ENERGY_DRIFT,DEBUG,COORDINATION,CUSTOM,PRINT" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
