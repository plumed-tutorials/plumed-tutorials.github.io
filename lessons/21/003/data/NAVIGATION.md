...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DUMPGRID,REWEIGHT_BIAS,READ,BIASVALUE,CONVERT_TO_FES,MOLINFO,PRINT,HISTOGRAM,RESTRAINT,CUSTOM,TORSION" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
