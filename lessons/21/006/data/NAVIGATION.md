...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CLASSICAL_MDS,DUMPGRID,MORE_THAN,ANTIBETARMSD,GROUP,PCAVARS,PCA,COORDINATIONNUMBER,PROJECT_POINTS,SKETCHMAP,COMMITTOR,ALPHARMSD,LANDMARK_SELECT_FPS,MOLINFO,PARABETARMSD,TORSION,PRINT,DUMPMULTICOLVAR,FCCUBIC,DUMPPDB,COLLECT_FRAMES,DUMPVECTOR,UNITS,RMSD,HISTOGRAM,PATH" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
