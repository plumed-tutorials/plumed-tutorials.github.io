...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PARABETARMSD,GYRATION,MOLINFO,PRINT,WHOLEMOLECULES,COMBINE,DUMPATOMS,CENTER,TORSION,ALPHARMSD,ANTIBETARMSD,DISTANCE" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
