...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ALPHARMSD,PARABETARMSD,GYRATION,PRINT,DUMPATOMS,COMBINE,MOLINFO,TORSION,ANTIBETARMSD,CENTER,WHOLEMOLECULES,DISTANCE" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
