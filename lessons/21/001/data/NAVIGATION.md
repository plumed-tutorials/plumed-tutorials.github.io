...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DISTANCE,CENTER,PARABETARMSD,PRINT,GYRATION,COMBINE,MOLINFO,ALPHARMSD,DUMPATOMS,TORSION,ANTIBETARMSD,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
