...
- Use [WHAM](https://www.plumed.org/doc-master/user-doc/html/_w_h_a_m.html) to combine multiple simulations performed with different topologies and/or bias potentials. 
...
<div class="tooltip" style="color:green">PRINT<div class="right">Print quantities to a file. <a href="https://www.plumed.org/doc-master/user-doc/html/_p_r_i_n_t.html" style="color:green">More details</a><i></i></div></div> <div class="tooltip">ARG<div class="right">the labels of the values that you would like to print to the file<i></i></div></div>=<b name="data/INSTRUCTIONS.md_working_1.datphi">phi</b> <div class="tooltip">FILE<div class="right">the name of the file on which to output these quantities<i></i></div></div>=COLVAR
</pre>
 {% endraw %} 
...
### Exercise 4: Analyze Hamiltonian replica exchange simulations with [WHAM](https://www.plumed.org/doc-master/user-doc/html/_w_h_a_m.html) 
