...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=SUM,CLUSTER_NATOMS,COORDINATIONNUMBER,FLUSH,ONES,MORE_THAN,GROUP,CLUSTER_DISTRIBUTION,PRINT,MATRIX_VECTOR_PRODUCT,RESTRAINT,CONTACT_MATRIX,DFSCLUSTERING" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
