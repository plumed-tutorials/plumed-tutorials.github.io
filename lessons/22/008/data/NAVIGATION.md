...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MATRIX_VECTOR_PRODUCT,ONES,GROUP,COORDINATIONNUMBER,SUM,PRINT,DFSCLUSTERING,MORE_THAN,FLUSH,MEAN,RESTRAINT,CLUSTER_DISTRIBUTION,CLUSTER_NATOMS,CONTACT_MATRIX" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
