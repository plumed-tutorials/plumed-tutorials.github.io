...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPT_AVERAGED_SGD,REWEIGHT_BIAS,UPPER_WALLS,DISTANCE,CONVERT_TO_FES,PRINT,TD_WELLTEMPERED,BF_WAVELETS,READ,COORDINATION,DUMPGRID,TD_UNIFORM,VES_LINEAR_EXPANSION,HISTOGRAM,BF_LEGENDRE" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
