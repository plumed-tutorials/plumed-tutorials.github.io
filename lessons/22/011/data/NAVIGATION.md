...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=READ,BF_LEGENDRE,CONVERT_TO_FES,BF_WAVELETS,COORDINATION,PRINT,HISTOGRAM,REWEIGHT_BIAS,DUMPGRID,UPPER_WALLS,TD_WELLTEMPERED,OPT_AVERAGED_SGD,VES_LINEAR_EXPANSION,TD_UNIFORM,DISTANCE" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
