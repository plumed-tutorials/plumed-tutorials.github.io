...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPT_AVERAGED_SGD,TD_UNIFORM,VES_LINEAR_EXPANSION,DUMPGRID,COORDINATION,DISTANCE,BF_LEGENDRE,PRINT,REWEIGHT_BIAS,BF_WAVELETS,UPPER_WALLS,READ,CONVERT_TO_FES,HISTOGRAM,TD_WELLTEMPERED" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
