...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,BF_LEGENDRE,CONVERT_TO_FES,TD_WELLTEMPERED,DISTANCE,READ,OPT_AVERAGED_SGD,TD_UNIFORM,VES_LINEAR_EXPANSION,HISTOGRAM,DUMPGRID,REWEIGHT_BIAS,UPPER_WALLS,BF_WAVELETS,COORDINATION" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
